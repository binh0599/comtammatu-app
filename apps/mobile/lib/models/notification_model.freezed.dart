...
mixin _$NotificationItem {
  ...
  String get type =>
      throw _privateConstructorUsedError; // 'order' | 'promotion' | 'loyalty' | 'system'
...
class _$NotificationItemImpl implements _NotificationItem {
  ...
  @override
  final String type;
// 'order' | 'promotion' | 'loyalty' | 'system'
  @override
  final bool isRead;
  @override
  ...
  @override
  String toString() {
    return 'NotificationItem(id: $id, title: $title, body: $body, type: $type, isRead: $isRead, createdAt: $createdAt, data: $data)';
  }
...
abstract class _NotificationItem implements NotificationItem {
  const factory _NotificationItem(
      ...
      final Map<String, dynamic>? data}) = _$NotificationItemImpl;
  ...
  String get body;
  @override
  String get type; // 'order' | 'promotion' | 'loyalty' | 'system'
  @override
  bool get isRead;
  @override
