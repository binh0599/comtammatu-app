...
class _$LoyaltyMemberImpl implements _LoyaltyMember {
  ...
  @override
  String toString() {
    return 'LoyaltyMember(id: $id, fullName: $fullName, phone: $phone, totalPoints: $totalPoints, availablePoints: $availablePoints, lifetimePoints: $lifetimePoints, version: $version, avatarUrl: $avatarUrl)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, fullName, phone, totalPoints,
      availablePoints, lifetimePoints, version, avatarUrl);
